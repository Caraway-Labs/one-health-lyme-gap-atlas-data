...
-- Snowflake reserves -20000; custom SQL procedure exception codes must be
-- below that boundary. Replace only the approval procedure, retaining its
-- immutable-decision and source-version behavior.
...
$$
DECLARE
  invalid_resource EXCEPTION (-20007, 'This DEV console supports only CDC/Socrata x5j9-wybp');
