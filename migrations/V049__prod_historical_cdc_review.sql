-- PROD-only extension of the existing human-review boundary; no source approval or RAW writes.
USE DATABASE {{ DATABASE }};

-- Extend PROD review to the two allowlisted geographic CDC eras.
