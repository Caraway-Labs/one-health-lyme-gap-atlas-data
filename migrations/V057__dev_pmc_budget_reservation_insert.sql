-- DEV-only forward repair: Snowflake does not allow UUID_STRING() directly in
-- a VALUES clause inside this SQL procedure.  Preserve the fail-closed budget
-- gate by inserting through SELECT instead.
