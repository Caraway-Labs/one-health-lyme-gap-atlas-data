...
CREATE TABLE IF NOT EXISTS ANALYTICS.INFECTED_TICK_DERIVED_RESULTS (
...
GRANT USAGE ON SCHEMA ANALYTICS TO ROLE OH_LYME_DEV_RUNTIME;
GRANT SELECT, INSERT ON TABLE ANALYTICS.INFECTED_TICK_DERIVED_RESULTS
    TO ROLE OH_LYME_DEV_RUNTIME;
GRANT USAGE ON SCHEMA ANALYTICS TO ROLE OH_LYME_DEV_READ;
GRANT SELECT ON TABLE ANALYTICS.INFECTED_TICK_DERIVED_RESULTS
