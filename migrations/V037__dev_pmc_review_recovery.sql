...
-- Ownership returns to the dedicated review-owner role through the documented
-- DEV deployment handoff. The GitHub migration role cannot COPY CURRENT
-- GRANTS without account-level MANAGE GRANTS.
